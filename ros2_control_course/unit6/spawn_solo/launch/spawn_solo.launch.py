...
def generate_launch_description():
    ...
    robot_model_package = "solo_description"
    robot_model_relative_path = "description"
    robot_model_file = "odri_solo_quadruped.urdf.xacro"
    robot_name = "solo"
    position_x = "0.0"
    position_y = "0.0"
    position_z = "0.0"
    ...
    spawn_entity = Node(package='spawn_solo',
